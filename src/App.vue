...
// Gestion de l'état d'ouverture de la barre latérale (surtout pour le mobile)
...
<template>
  <div class="min-h-screen bg-[#F2F2DE] font-sans text-slate-900">
    ...
    <div v-if="isAuthenticated" class="fixed inset-0 flex">
      <!-- Sidebar : On passe l'état via v-model -->
      <AppSidebar v-model:open="sidebarOpen" />

      <!-- Contenu principal -->
      <div class="flex flex-1 flex-col overflow-hidden">
        <!-- Navbar : Le bouton burger déclenche l'événement toggle-sidebar -->
