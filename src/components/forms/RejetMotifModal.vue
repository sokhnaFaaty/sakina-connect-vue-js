...
<template>
  <form @submit.prevent="confirmer" class="grid gap-4">
    <div>
      ...
      <textarea id="motifRejet" v-model="motif" rows="3" :placeholder="placeholder" class="w-full rounded-2xl border bg-white px-4 py-3 text-sm" :class="motifError ? 'border-rose-500 focus:border-rose-500' : 'border-slate-200'"></textarea>
