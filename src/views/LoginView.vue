  ...
  <div class="flex min-h-screen flex-col lg:grid lg:grid-cols-2">
    ...
    <div class="relative flex flex-col justify-center overflow-hidden p-8 text-white lg:p-14" :style="bgStyle">
      ...
      <p class="mt-4 max-w-md text-slate-200">
        Plateforme de gestion des voyages Omra &amp; Hajj : suivi des pèlerins et des groupes, itinéraires et assistance SOS géolocalisée en temps réel.
      </p>
    ...
    <div class="flex items-center justify-center bg-[#F2F2DE] p-6 sm:p-10 lg:p-14">
      <div class="w-full max-w-md">
        ...
        <div v-if="erreurMessage" class="mt-6 rounded-xl bg-rose-50 px-4 py-3 text-sm font-semibold text-rose-600">
        ...
        <div class="mt-6 grid gap-4">
          <div>
            ...
            <input v-model="email" class="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm outline-none focus:border-[#BC7B3B] focus:ring-2 focus:ring-[#BC7B3B]/30" type="email" id="loginEmail" placeholder="nom@gmail.com" autocomplete="email" />
          </div>

          <div>
            <label class="mb-1 block text-xs font-bold text-[#333D2A]" for="loginPassword">Mot de passe :</label>
            <div class="relative">
              <input v-model="motDePasse" class="w-full rounded-xl border border-slate-300 bg-white px-4 py-3 text-sm outline-none focus:border-[#BC7B3B] focus:ring-2 focus:ring-[#BC7B3B]/30" type="password" id="loginPassword" placeholder="••••••••••••" autocomplete="current-password" />
            </div>
          </div>

          <button @click="seConnecter" :disabled="chargement" class="mt-2 flex w-full items-center justify-center gap-2 rounded-xl bg-[#333D2A] px-4 py-3 text-sm font-bold text-white transition hover:opacity-90 disabled:cursor-not-allowed disabled:opacity-60">
